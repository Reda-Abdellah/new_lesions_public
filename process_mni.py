...
os.system(cmd)
"""
os.system('mkdir /data/patients_preprocessed/')
os.system('mkdir /data/patients_preprocessed/patient_X')
shutil.copyfile(flair1_name, preprocessed_flair1_name)
shutil.copyfile(flair2_name, preprocessed_flair2_name)
shutil.copyfile('/test/brain_mask.nii.gz', '/data/patients_preprocessed/patient_X/brain_mask.nii.gz')
#"""
